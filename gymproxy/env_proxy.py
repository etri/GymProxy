...
class EnvProxy(ABC):
    ...
    def reset_actual_env(self):
        ...
        def reset_actual_env_():
            ...
            self._reset_actual_env(self._actual_env, config=self._config)   # Actually resets the actual environment.
        ...
        self._future = self._pool.submit(reset_actual_env_)
