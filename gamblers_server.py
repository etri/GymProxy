...
if __name__ == "__main__":
    ...
    config = (
        ...
        .environment(
            env=None,
            # Define observation and action spaces for the Gambler's Problem
            observation_space=gymnasium.spaces.Box(0, 100, shape=(1,), dtype=np.int32),
            action_space=gymnasium.spaces.Discrete(101),  # Bet can be from 0 to 100
        )
        # DL framework to use.
    ...
    if args.no_tune:
        ...
        for _ in range(args.stop_iters):
            ...
            if (
                results[ENV_RUNNER_RESULTS] >= args.stop_reward
    ...
    # Run with Tune for auto env and algo creation and TensorBoard.
        ...
        stop = {
            ...
            f"{ENV_RUNNER_RESULTS}": args.stop_reward,
        }
